...
from se_theory_structural_explainability.reference import (
    LeanDecl,
    _ArtifactResult,
    _extract_decls,
...
def test_run_scaffold_adds_stub_for_new_symbol(
    ...
    monkeypatch.setattr(
        "se_theory_structural_explainability.reference._find_repo_root", lambda: repo
    )
...
def test_run_scaffold_missing_index_returns_1(
    ...
    monkeypatch.setattr(
        "se_theory_structural_explainability.reference._find_repo_root",
        lambda: tmp_path,
    )
